...
function mousePressed(){
  ...
  if(gameover){
    ...
    let i = floor(mouseX/tamanhoCasa);
    let j = floor(mouseY/tamanhoCasa);
...
function IAJoga(){
  let indiceAleatorio = floor(random(casasDisponiveis.length));
  let i = casasDisponiveis[indiceAleatorio][0];
  let j = casasDisponiveis[indiceAleatorio][1];
  
  tabuleiro[i][j] = jogador2;
  
  casasDisponiveis.splice(indiceAleatorio,1);
